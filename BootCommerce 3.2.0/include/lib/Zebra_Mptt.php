...
class Zebra_Mptt
{
     ...
     *  @return void
     */
    function Zebra_Mptt($table_name = 'categories', $id_column = 'id',$level_column = 'level', $status_column = 'status', $tree_column = 'tree_path', $title_column = 'name', $left_column = 'sx', $right_column = 'dx', $parent_column = 'parent',$meta_description_column = 'meta_description',$meta_keywords_column = 'meta_keywords') {
        global $table_prefix;
