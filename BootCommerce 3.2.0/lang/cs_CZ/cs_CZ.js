...
var $lang_client_ = {           
		   ...
		   'alert_product_add_to_cart':'{name}<br/><img class="img-polaroid" width="100" src="{url_img}" alt="{name}" /><br/><br/>byl přidán do nákupního košíku<br/><br/><span class="close-add-to-cart-loader btn btn-info squared unbordered solid">Pokračovat v nakupování</span> <a href="{link_cart}" class="close-add-to-cart-loader btn btn-primary squared unbordered solid">Zobrazit košík</a>',
